    ...
    <br><br>
                <?php
                    try{
                        ...
                        $sqlquerystring="SELECT email,name,photo,institution,address,year,phone FROM student";
                      ...
                      foreach($tabledata AS $row){
                        ?>
                            ...
                            <td>
                                <input type="button" value="Update Profile" onclick="update_profilefn();" >
                            </td>-->
                    ...
                    <!--<script> function update_profilefn(){
                       location.assign('updateprofile.php');
    ...
    <div class="card-container">
      ...
      <div class="lower-container">
        ...
        <input type="button" class="button" value="Update profile" onclick="updatefn('<?php echo $row['email']; ?>');">
            ...
            location.assign('updatestudentprofile.php?email='+email);
