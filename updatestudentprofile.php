<?php
    $email="student@gmail.com";
        try{
            ...
            $sqlquerystring="SELECT name,institution,address,year,phone
                             FROM student
                             WHERE email='$email'";
...
<head>
    ...
    <style>
           ...
           body{
                background-image:url(bgpic4.jpg);
...
<input type="button" class="button" value="Back"  onclick="homefn();">
      ...
      <form action="updatestudentprocess.php"method="POST">
          ...
          <br>
          <br>
          <label for="Institution"><b><font color="White">Institution:</font></b></label>
          <input type="text" value="<?php echo $institution ?>" id="institution" name="institution" style="height:30px; width:260px" />
          <br>
          <br>
          ...
          <br>
          <br>
           <label for="year"><b><font color="White">Year:</font></b></label>
          <input type="text" value="<?php echo $year ?>" id="year" name="year"  style="height:30px; width:260px" />
          <br>
          <br>
